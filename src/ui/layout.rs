...
mod tests {
    ...
    fn hidden_thumbnail_uses_all_content_space() {
        ...
        assert_rect(layout.title_bar, RectF::new(0.0, 0.0, 1280.0, 44.0));
        assert_rect(layout.canvas, RectF::new(0.0, 44.0, 1280.0, 712.0));
    ...
    fn docks_thumbnail_panel_on_every_edge() {
        let expected = [
            (
                ThumbnailDock::Top,
                RectF::new(0.0, 44.0, 1280.0, 92.0),
                RectF::new(0.0, 44.0, 1280.0, 712.0),
            ),
            (
                ThumbnailDock::Bottom,
                RectF::new(0.0, 664.0, 1280.0, 92.0),
                RectF::new(0.0, 44.0, 1280.0, 712.0),
            ),
            (
                ThumbnailDock::Left,
                RectF::new(0.0, 44.0, 92.0, 712.0),
                RectF::new(0.0, 44.0, 1280.0, 712.0),
            ),
            (
                ThumbnailDock::Right,
                RectF::new(1188.0, 44.0, 92.0, 712.0),
                RectF::new(0.0, 44.0, 1280.0, 712.0),
            ),
        ];
